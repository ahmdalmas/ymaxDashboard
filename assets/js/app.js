...
$("#grayScale").on("click", function () {
  ...
  $("#CurrentpassIcon").on("click", function () {
    $("#CurrentpassIcon iconify-icon").toggle();
  });
  ...
  var showElements = document.querySelectorAll('.js-show');

  showElements.forEach(function(element) {
    var pass = element.querySelector('.js-pass'); // Changed to match the specific input class
    var input = element.querySelector('.passIcon'); // Changed to match the specific button class

    input.addEventListener('click', function() {
      if (pass.type === 'password') {
        pass.type = 'text';
        element.querySelector('.passwordhide').classList.add('hidden'); // Changed to use element.querySelector
        element.querySelector('.passwordshow').classList.remove('hidden'); // Changed to use element.querySelector
      } else {
        pass.type = 'password';
        element.querySelector('.passwordhide').classList.remove('hidden'); // Changed to use element.querySelector
        element.querySelector('.passwordshow').classList.add('hidden'); // Changed to use element.querySelector
      }
    });
  });
});
